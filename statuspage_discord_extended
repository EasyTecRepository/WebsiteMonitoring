...
DOMAIN7="http://your.domain.example"
...
### DISCORD SETTINGS ###
# WEBHOOK OF YOUR DISCORD CHANNEL
# YOUR WEBHOOK
...
#NAMES OF THE SERVICES OF YOUR STATUSPAGE
SERVICE_NAME_1="your service name"
SERVICE_NAME_2="your service name"
SERVICE_NAME_3="your service name"
SERVICE_NAME_4="your service name"
SERVICE_NAME_5="your service name"
SERVICE_NAME_6="your service name"
SERVICE_NAME_7="your service name"
...
# ARRAYS
raw_DOMAIN_array=("$DOMAIN1" "$DOMAIN2" "$DOMAIN3" "$DOMAIN4" "$DOMAIN5" "$DOMAIN6" "$DOMAIN7")
raw_COMPONENTID_array=("$COMPONENTID1" "$COMPONENTID2" "$COMPONENTID3" "$COMPONENTID4" "$COMPONENTID5" "$COMPONENTID6" "$COMPONENTID7")
DOMAIN_array=()
COMPONENTID_array=()
DOMAIN_array_DISCORD=()
array_REPORTED_WEBSITES=("$SERVICE_NAME_1" "$SERVICE_NAME_2" "$SERVICE_NAME_3" "$SERVICE_NAME_4" "$SERVICE_NAME_5" "$SERVICE_NAME_6" "$SERVICE_NAME_7")
...
for i in {0..6}; do
    ...
    DOMAIN_array_DISCORD[$i]="$domain_status"
done
...
if [[ "${DOMAIN_array[*]}" == "200 200 200 200 200 200 200" ]] && [ -z "$quest_incident_first" ]; then
    echo "STATUS: OKAY"
    ...
    for schleife in {0..6}; do
        ...
        if [ ! -z "$quest_incident_actual" ] && [ "${DOMAIN_array[$schleife]}" = "200" ] && [[ ! "$quest_status" == *"operational"* ]]; then
            ...
            sudo bash discord.sh --webhook-url="$WEBHOOK" --username "$DISCORD_USERNAME" --avatar "$DISCORD_AVATAR_URL" --title "$DISCORD_OKAY_TITLE" --description "Service(s) affected: "${array_REPORTED_WEBSITES[$schleife]}"" --color "$DISCORD_OKAY_COLOR" --author "$DISCORD_AUTHOR" --author-url "$DISCORD_AUTHOR_URL" --author-icon "$DISCORD_AUTHOR_ICON" --thumbnail "$DISCORD_OKAY_THUMBNAIL" --field "CURRENT STATUS:;"${DOMAIN_array_DISCORD[$schleife]}"" --footer "automatically generated message" --timestamp
            status="0.1"
            ...
            sudo bash discord.sh --webhook-url="$WEBHOOK" --username "$DISCORD_USERNAME" --avatar "$DISCORD_AVATAR_URL" --title "$DISCORD_ERROR_TITLE" --description "Service(s) affected: "${array_REPORTED_WEBSITES[$schleife]}"" --color "$DISCORD_ERROR_COLOR" --author "$DISCORD_AUTHOR" --author-url "$DISCORD_AUTHOR_URL" --author-icon "$DISCORD_AUTHOR_ICON" --thumbnail "$DISCORD_ERROR_THUMBNAIL" --field "CURRENT STATUS:;"${DOMAIN_array_DISCORD[$schleife]}"" --footer "automatically generated message" --timestamp
            status="1"
            echo "$status" # ONLY FOR DEBUG
            ...
            sudo bash discord.sh --webhook-url="$WEBHOOK" --username "$DISCORD_USERNAME" --avatar "$DISCORD_AVATAR_URL" --title "$DISCORD_ERROR_TITLE" --description "Service(s) affected: "${array_REPORTED_WEBSITES[$schleife]}"" --color "$DISCORD_MAINTENANCE_COLOR" --author "$DISCORD_AUTHOR" --author-url "$DISCORD_AUTHOR_URL" --author-icon "$DISCORD_AUTHOR_ICON" --thumbnail "$DISCORD_MAINTENANCE_THUMBNAIL" --field "CURRENT STATUS:;"${DOMAIN_array_DISCORD[$schleife]}"" --footer "automatically generated message" --timestamp
            status="2"
            echo "$status" # ONLY FOR DEBUG
        #4xx Client-errors   
            ...
            sudo bash discord.sh --webhook-url="$WEBHOOK" --username "$DISCORD_USERNAME" --avatar "$DISCORD_AVATAR_URL" --title "$DISCORD_ERROR_TITLE" --description "Service(s) affected: "${array_REPORTED_WEBSITES[$schleife]}"" --color "$DISCORD_FAILURE_COLOR" --author "$DISCORD_AUTHOR" --author-url "$DISCORD_AUTHOR_URL" --author-icon "$DISCORD_AUTHOR_ICON" --thumbnail "$DISCORD_FAILURE_THUMBNAIL" --field "CURRENT STATUS:;"${DOMAIN_array_DISCORD[$schleife]}"" --footer "automatically generated message" --timestamp
            status="4.1"
            echo "$status" # ONLY FOR DEBUG
        ...
        if [[ "${DOMAIN_array[*]}" == "200 200 200 200 200 200 200" ]] && [ ! -z "$quest_incident_actual" ]; then
            ...
            sudo bash discord.sh --webhook-url="$WEBHOOK" --username "$DISCORD_USERNAME" --avatar "$DISCORD_AVATAR_URL" --title "$DISCORD_OKAY_TITLE" --description "Incident present without error of a website" --color "$DISCORD_OKAY_COLOR" --author "$DISCORD_AUTHOR" --author-url "$DISCORD_AUTHOR_URL" --author-icon "$DISCORD_AUTHOR_ICON" --thumbnail "$DISCORD_OKAY_THUMBNAIL" --field "CURRENT STATUS:;"${DOMAIN_array_DISCORD[$schleife]}"" --footer "automatically generated message" --timestamp
            status="0.5"
            echo "$status" # ONLY FOR DEBUG
        else
            freeplace="ok"
